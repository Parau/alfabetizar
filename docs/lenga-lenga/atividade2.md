...
sidebar_label: Produção textual
---
...
1. Leitura e Exploração de Modelos
   * **Leitura** do [Dez Capivaras](capivara).
   * Destaque rimas, repetições e estrutura dos textos. Outros exemplos:
     * [Nove irmãs](tipos#tangolomangos).
...
1. Cada grupo deve **escolher**
    1. Situação.
    1. Dez elementos.
    2. Escriba (versão final do texto).
1. Durante a escrita promova "intervenções pedagógicas"
...
Antes de iniciar o projeto, você pode realizar a [Semana da lenga-lenga](atividade1), proporcionando uma imersão mais ampla nesse tipo de texto. Caso isso não seja possível, reserve ao menos um momento para a leitura de dois dos livros sugeridos abaixo:
   * **Leitura** do [Dez Capivaras](capivara).
   * Destaque rimas, repetições e estrutura dos textos. Outros exemplos:
     * [Nove irmãs](tipos#tangolomangos).
     * “Dez Sacizinhos”, de Tatiana Belinky.
...
Essas perguntas não apenas promovem a reflexão sobre o **sistema de escrita alfabética**, mas também ajudam os alunos a monitorarem o próprio texto, confrontando suas hipóteses com o conhecimento já construído. É importante também considerar questões relacionadas **à estrutura do gênero**, questionando:
– *O que precisa acontecer no final para sobrar só um personagem?*
– *Será que esse trecho está rimando como nos exemplos que lemos?*
– *O que precisa aparecer no seu texto para ele parecer um tangolomango?*
